...
map.feature(languages = check$Language,
            latitude = as.numeric(check$Lat),
            longitude = as.numeric(check$Lon),
            features = check$classes,
            label = paste(check$Language, check$dialect),
            popup = check$EngNames,
            tile = 'CartoDB.Positron',
            color = "viridis",
            width = 3, stroke.radius = 3)
